...
require File.expand_path(File.join(File.dirname(__FILE__), 'addressing_mode_nodes.rb'))
...
class Parser
  ...
  Treetop.load(File.expand_path(File.join(File.dirname(__FILE__), 'addressing_mode.treetop')))
